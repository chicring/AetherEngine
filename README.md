...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "6.4.4")
```
...
Pin to `.upToNextMinor(from: "6.4.4")` for stricter teams that prefer to opt into minor bumps explicitly.

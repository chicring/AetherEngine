...
enum SessionOptionCorrection {
    ...
    static let knownFields: [String] = [
        ...
        "preserveASSMarkup", "prepareNativeSubtitles", "prepareBitmapSubtitleOCR",
        "eagerNativeSubtitleReaders", "confirmAtmos",
        "nativeSubtitlePreferredLanguages", "sequentialOrigin", "maxConcurrentSourceRequests",
        "declaredDurationSeconds", "probesize", "maxAnalyzeDuration", "shortFirstSegmentSeconds",
        "preferredAudioLanguages",
        "preferredSubtitleLanguages", "externalSubtitles", "forwardBufferSegments", "diskCacheBudgetBytes",
        "autoplay",
